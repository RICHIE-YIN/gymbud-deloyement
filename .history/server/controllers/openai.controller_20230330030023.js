...
generateMealPlan: async (req, res) => {
    ...
    const prompt = `Generate me a basic meal plan to hit my macros and nutrition goals. My target calories is ${calories}. I want ${fat}g fat, ${protein}g protein, and ${carbs}g carbs. Make it into ${meals} meals a day. In your response I want you to name the meal, and list all of the ingredients to make it.`;
    console.log(prompt);
