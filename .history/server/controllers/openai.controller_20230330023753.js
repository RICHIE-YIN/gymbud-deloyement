...
generateMealPlan: async (req, res) => {
    ...
    const prompt = `Generate me a basic meal plan to hit my macros and nutrition goals. My target calories is ${calories}. I want ${fat}g fat, ${protein}g protein, and ${carbs}g carbs. Make it into ${meals} meals a day. Name the meals and show the macros per meal.`;
    console.log(prompt);
